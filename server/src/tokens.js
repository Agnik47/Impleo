...
// Emits the per-call token/routing breakdown to the server console in the
// exact shape asked for in the optimization brief. Estimates only (see above);
// prefixed so it's greppable in the dev-server output.
