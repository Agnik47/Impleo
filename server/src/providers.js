...
// test-key.js don't care which one is active.
//
...
// Which settings column holds each provider's key/model. Used by settings.js
// and generate.js; kept here so the provider list has a single source of truth.
